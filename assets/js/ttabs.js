...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        lang: { // Language variables for button
            ...
            login: "I don't want to login in"
        },
        toolbarSettings: {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setElements: function () {
            ...
            // Set anchor elements
            this.nav.addClass('multistep-nav multistep-nav-tabs step-anchor').children('li').addClass('multistep-nav-item').children('a').addClass('nav-link'); // nav-justified  nav-pills
        ...
        _setToolbar: function () {
            ...
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass('button sw-btn-prev').attr('type', 'button') : null;
            //var btnPlaceoRder = $('<button></button>').text(this.options.lang.placeorder).addClass('button btn-hide ci-place-order').attr('type', 'button');
            var btnGroup = $('<div></div>').addClass('btn-wapper').append(btnPrevious, btnNext);
        ...
        _setButtons: function (idx) {
            ...
            if (!this.options.cycleSteps) {
                if (0 >= idx) {
                    ...
                    $('.sw-btn-prev', this.main).addClass("btn-hide");

                    $('.sw-btn-next', this.main).text(this.options.lang.login);
                } else {
                    $('.sw-btn-prev', this.main).removeClass("disabled");
                    $('.sw-btn-prev', this.main).removeClass("btn-hide");

                     $('.sw-btn-next', this.main).text(this.options.lang.next);
                }
                if (this.steps.length - 1 <= idx) {
                    $('.sw-btn-next', this.main).addClass("disabled btn-hide");
                 //   $('.ci-place-order', this.main).removeClass("btn-hide");
                } else {
                  //  $('.ci-place-order', this.main).addClass("btn-hide");
                    $('.sw-btn-next', this.main).removeClass("btn-hide");
                }
            }
            return true;
        },
