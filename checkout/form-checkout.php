...
<form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<div id="step-5" class="tab-pane step-content">
		<h3 id="order_review_heading"><?php esc_html_e( 'Your Order', 'multistep-checkout' ); ?></h3>
	...
	<div id="step-6" class="tab-pane step-content">
		<h3 id="order_payment_heading"><?php esc_html_e( 'Payment', 'multistep-checkout' ); ?></h3>

		

		<div id="order_review" class="ci-checkout-payment">
			<?php do_action( 'ci_multistep_checkout_payment' ); ?>
		</div>
